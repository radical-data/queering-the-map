	...
	<div class="overlay__outer">
		<div class="overlay__content">
			...
			<section style={active_tab !== 2 ? 'display: none;' : ''}>
				...
				<div class="overlay__section-text">
					<p>
						Queering the Map is a grassroots endeavour, and relies on donations to cover the costs
						of keeping the site alive. Please support the future of Queering The Map by making a
						donation through our Patreon!
					</p>
			...
			<section style={active_tab !== 3 ? 'display: none;' : ''}>
				...
				<div class="overlay__section-text removal_textarea">
					<p>
						...
						feel shouldn't be there, please contact us at <a href="mailto:hi@queeringthemap.com"
			...
			<section style={active_tab !== 5 ? 'display: none;' : ''}>
				...
				<div class="overlay__section-text">
					<p>
						...
						upcoming moderator onboarding sessions, please email us at <a
				...
				<div class="overlay__section-text">
					...
					<div class="partial_div-numbered">
						...
						Creative Commons license, and specify if you've made any changes to the original
						content.
					</div>
					<br />
					<div class="partial_div-numbered">
					...
					<p>
						If you have any questions, or are interested in exploring a collaborative project with
						us, please email us at <a href="mailto:hi@queeringthemap.com">hi@queeringthemap.com</a>.
					</p>
				</div>
			</section>
			...
			<section style={active_tab !== 6 ? 'display: none;' : ''}>
				...
				<div class="privacy_policy overlay__section-text">
					...
					<p>
						...
						conditions and rules of using Queering the Map. Because legal jargon is often intricate,
						lengthy and dull, we have created a summary of the key points to keep in mind while
						using this website.
					</p>
					<p>
						It's important to note that this summary is not intended to replace the complete Terms
					...
					<ul>
						...
						<li>
							<p>
								...
								specific guidelines. Your content must comply with all laws and be uploaded only if
								you have the rights to it or permission from the owner. Additionally, your content
								must not promote hate, violence, or discrimination, disclose personal contact
								information, infringe on intellectual property rights, impersonate others, contain
								harmful software, serve commercial purposes, or engage in spam or fraudulent
								activities.
							</p>
						</li>
						<li>
							<p>
								...
								Attribution-NonCommercial-ShareAlike 4.0 International License, which allows you to
								share and adapt the material on the website as long as you give appropriate credit,
								use it for non-commercial purposes, and share any adaptations under the same
								license. By accessing or using the website, you agree to comply with these terms.
							</p>
						</li>
						<li>
						...
						<li>
							<p>
								While we try to keep our Services up and running, sometimes the site may go down,
								data may be lost, or other issues may arise. We will try to fix these issues, but we
								are not liable to you or any other users if such issues arise.
							</p>
						</li>
						<li>
							<p>
					...
					<p>
						...
						(“Queering the Map”, “we”, “our”, “us”). These terms and conditions of use, together
						with our Privacy Policy and all supplemental terms (as amended from time to time), other
						documents and policies that are expressly referenced in these terms and conditions (the
						“Terms”), govern your use of the Services.
					</p>
					<p>
						Please read these Terms carefully. These Terms form a legally binding contract between
						you and us. By downloading, accessing or otherwise using any Queering the Map Services
						in any way, you agree to be bound by these Terms. If you do not agree to be bound by
						these Terms you should not access, post User Content on, or otherwise engage with any
						Queering the Map Services.
					</p>
					<p>
						Please keep a copy of these terms for future reference. You should check these terms
						every time you use any Queering the Map Services as we may change these terms at any
					...
					<p>
						...
						alterations to Queering the Map Services; (e) improvements for clarity and consistency;
						or (f) any other reason within our sole discretion.
					</p>

					<p>
						Please check the Terms whenever you use any Queering the Map Services. We will treat
						your continued use of the Queering the Map Services as acceptance of any changes made to
						the Terms from the previous version. If you do not agree with the changes you should
					...
					<p>
						By posting content through the Service, you grant the Service the unlimited and
						worldwide right and license, without any monetary compensation, to use, modify, publicly
						perform, publicly display, reproduce, and distribute such content on and through the
						Service, and its derivatives in any and all media and format, whether such Service
						and/or derivatives are distributed directly by us or through third parties under license
						by us. You agree that this license includes the right for the Service to make your
						content available to other users of the Service and its derivatives, who may also use,
						share, repost and/or display your content subject to these terms.
					</p>

					<p>
						You represent and warrant that: (i) the content you post is yours (you own it) or you
						have the right to use it and grant us the rights and license as provided in these terms,
						and (ii) the posting of your content on or through the Service and the exercise by the
						Service or any third-party licensee of any of the rights granted by you under these
						Terms does not and will not violate the privacy rights, publicity rights, copyrights,
						contract rights or any other rights of any person. You hereby release the Service and
						our third-party licensees from any claims of any kind or nature arising from the use of
						your content as permitted hereunder, including those based upon defamation, invasion of
					...
					<p>
						...
						at any time, and for any reason, please contact us at <a
							href="mailto:hi@queeringthemap.com">hi@queeringthemap.com</a
						>. We will remove your content from the Queering the Map Services in a reasonable and
						timely manner.
					</p>
					<p>
						We retain the right to remove User Content from Queering the Map Services at any time,
						and for any reason.
					</p>
					...
					<p>
						...
						created or posted by you satisfies the requirements set out in this Section 5. These
						requirements apply in addition to any other policies or terms of use we provide or are
					...
					<ul class="voidcircle">
						...
						<li>
							Reveal details that enable you or anyone else to be identified or contacted outside of
							the Queering the Map Services (e.g. last name, postal address, email address,
						...
						<li>
							...
							copyrights, trademarks, database rights, any rights of confidentiality or any similar
							rights;
						</li>
						<li>
						...
						<li>
							Contain viruses, Trojans, worms, time-bombs, keystroke loggers, spyware, adware or any
							other harmful programs or similar computer code designed to affect the operation of
							any computer software, hardware or network;
						</li>
						<li>Have any commercial purpose;</li>
						<li>Involve junk mail, spam, pyramid selling or similar schemes; or</li>
						<li>
							Consist of any other content that, in our opinion breaches or may breach the spirit of
							or intention behind any of the above “must nots”.
						</li>
					</ul>
					...
					<p>
						...
						or using this website, you agree to comply with the terms of this License.The full text
					...
					<p>
						If you do not agree with the terms of this License, you are not authorized to use or
						access the Queering the Map Services. For any questions or clarifications regarding this
					...
					<p>
						...
						or owned by third-parties and licensed for our use.
					</p>
					<p>
						Materials (including without limit all information, software, data, text, photographs,
						graphics, sound and video) placed on any Queering the Map Services by us, or on our
						behalf, are protected by our (or our business partners/suppliers/advertisers or
						licensors) copyright and other intellectual property rights. You may not use these
						materials or any Queering the Map Services except in accordance with these Terms and for
						personal and non-commercial use only.
					</p>
					<p>
						You acknowledge that all intellectual property and other rights in any Queering the Map
						Services, including without limitation any content, and virtual items in the Queering
						the Map Services are and will remain the property of Queering the Map and/or our
						licensors. As part of the license granted under these Terms, you are only granted
						limited non transferrable, non-sub-licensable permission (which can be revoked at any
						time) to use such content or Queering the Map Services, subject to and in accordance
						with these Terms and solely for your personal and non-commercial use.
					</p>

					<p>
						Notwithstanding anything to the contrary herein, you acknowledge and agree that you
						shall have no ownership, title, or other proprietary interest in any Queering the Map
						Services. We do not permit any sale, gift or trade outside of the Queering the Map
						Services of anything that appears or originates in the Queering the Map Services.
					</p>

					<p>
						We reserve the right to stop offering any Queering the Map Services at any time, either
						permanently or temporarily, at which point any license granted to you to use the
						Queering the Map Services or a part thereof will be automatically terminated or
						suspended. In such event, Queering the Map shall not be required to provide refunds,
						benefits or other compensation to users in connection with such discontinued elements of
					...
					<p>
						...
						obtaining your parents’/guardians’ prior consent, you will be entitled to use the
						Queering the Map Services. We do not knowingly collect or store any personally
						identifiable information from children under 13.
					</p>
					<p>
						If you are under 18, by using the Queering the Map Services you are representing that
						you have consent from your parents/guardian to use the Queering the Map Services in
						accordance with our Terms. You and your parent(s) or guardian(s) must review these Terms
						together. Parents and guardians are responsible for the acts of children under 18 years
						of age when using the Queering the Map Services. We recommend that parents and guardians
					...
					<p>
						...
						including by way of regular updates, the Queering the Map Services and we may have to
						suspend operation of any Queering the Map Services without notice for repair,
						maintenance, improvement, security or any other reason. If so, we will do our best to
						ensure that the suspension is as short as possible. We cannot accept responsibility for
						such suspensions, interruptions or errors caused by circumstances outside our reasonable
						control.
					</p>
					<p>
						We cannot guarantee that any Queering the Map Services will work on or be compatible
						with or capable of being accessed on any particular devices, platforms, operating
						systems or equipment, or in conjunction with any particular non-Queering the Map
						approved software or connectivity services. We do not accept responsibility for such
						equipment, software or services. We also do not guarantee that the Queering the Map
					...
					<p>
						...
						technologies, or their content, products, or services as these are outside our
						reasonable control. Any third-party sites or technologies suggested are not endorsed,
						controlled, or verified by us. We do not guarantee that any suggested technologies will
						work on your computer or be virus free. Any suggestions made are not a warranty of any
						kind, and we are not responsible for any disruption, problem, damage, data loss, cost,
						or inconvenience caused by the suggested sites or technologies. We will not provide
						support for any sites or technologies which are not our own. We exercise no control over
						the copyright, patent, or trademark compliance or legality of the suggested sites or
						technologies.
					</p>
					...
					<p>
						...
						statutory warranties that you will be able to access or use any Queering the Map
						services at the times or locations of your choosing or that the Queering the Map
						services will be uninterrupted or free of errors, bugs, corruption, loss, interference,
						hacking, or viruses. Accordingly, we are not liable to you for any loss or damage that
						might arise, for example, from the inoperability, unavailability, or security
						vulnerabilities of the Queering the Map Services or from your reliance on the quality,
						accuracy, or reliability of the Queering the Map Services. We also make no guarantee
						that the Queering the Map services will work with or can be accessed on any particular
						devices, platforms, operating systems, or equipment, or in conjunction with any
					...
					<p>
						...
						costs, expenses, or damages that you suffer in connection with any Queering the Map
						services or these terms shall not exceed (in the aggregate) the fees paid to us by you
						for your use of the Queering the Map Services, if any. Notwithstanding the foregoing,
						nothing in these terms shall exclude or limit our liability for any loss or damage, to
						the extent that such liability cannot under any applicable law be excluded or limited.
					</p>
					<p>
						You will be liable for any loss or damage we suffer arising from your breach of these
						terms or misuse of the Queering the Map services.
					</p>
					...
					<p>
						...
						misrepresentation. Please note that we only provide Queering the Map Services for
						personal use. You agree not to use the Queering the Map Services for any commercial or
						business purposes, and we have no liability to you for any loss of profit, loss of
						business, business interruption, or loss of business opportunity or any indirect or
					...
					<p>
						...
						between the parties in relation to such matters. The limitations, exclusions and
						restrictions in these Terms shall inure to the benefit of our licensors, successor and
						assigns.
					</p>
					<p>
						These Terms are drafted in the English language and may be translated into other
						languages. The English language version of these Terms shall prevail if there is a
						conflict or inconsistency or clarification required with other language versions. The
						headings in these Terms are for ease of reference only and shall be disregarded in
						construing or interpreting the Terms. If we fail to enforce any provision of these
						Terms, that failure will not preclude us from enforcing either that provision (or any
						similar provision) on a later occasion. If any provision of these Terms is found by a
						court to be invalid, we agree that the court should endeavor to give effect to the
						parties’ intentions as reflected in the provision and that other provisions remain in
						full force and effect. We may transfer all or part of our rights or duties under these
						Terms provided we take reasonable steps to ensure that your rights under these Terms are
						not prejudiced.
					</p>

					<p>
						As these Terms are personal to you, you may not transfer any of your rights or duties
						under it without our prior written consent. A person who is not a party to these Terms
						shall have no rights to enforce any its terms. These Terms are governed by the laws of
						the province of Ontario. You and we both agree to the exclusive jurisdiction and venue
						of the provincial and federal courts of Ontario and stipulate to the fairness and
						convenience of proceedings in such courts for all disputes arising out of or relating to
					...
					<p>
						...
						nuclear, chemical or biological contamination, pandemic, strikes, civil action,
						unavailability of the internet, unscheduled hosting and maintenance to systems, power
						and data losses and acts of God. We shall not be obliged to perform our obligations
						under these Terms to the extent that we are prevented from doing so by reason of an
						event of force majeure. Performance of these Terms may cease during the continuation of
						the force majeure event and for such time after that event ceases as is necessary for us
						to start satisfying our obligations again. For so long as such force majeure event is
						continuing, our corresponding obligations under these Terms shall be suspended to the
						same extent. If such force majeure continues for a continuous period in excess of four
						months, we may terminate access to the Queering the Map Services immediately on service
						of notice to you.
					</p>
			...
			<section style={active_tab !== 7 ? 'display: none;' : ''}>
				...
				<div class="privacy_policy overlay__section-text">
					...
					<p>
						...
						information when you access and use our platform. Your privacy is crucial to us, and we
						are committed to maintaining the confidentiality and security of the information you
						provide. By using Queering the Map, you acknowledge that you have read and understood
						this Privacy Policy. Your continued use of the platform constitutes acceptance of any
						updates or changes to this policy. If you do not agree to this Privacy Policy, do not
						use Queering the Map.
					</p>
